...
/* This file is copied from the tt-wind driver (driver/ttwind_ioctl.h), following the same
 * convention as ioctl.h, which is copied from the Linux KMD. Do not edit here; update tt-wind
 * and re-copy. */
/*
